package ru.df5.pacmangame.units;
...
import ru.df5.pacmangame.GameMap;
import ru.df5.pacmangame.GameScreen;
...
public abstract class Unit implements Serializable {
    ...
    public void move(Direction direction, boolean isBot) {
        // teleportcell
            ...
            if (position.x == 27 && position.y == 18) {
                if(!isBot) {
                    position.x = 1;
                    destination.x = 1;
                } else {
